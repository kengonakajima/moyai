...
class Prop2D_OGL : public Prop, public Renderable {
public:
	...
	Grid *grids[MAX_GRID];  // ì™Ç©ÇÁì¸ÇÍÇƒÇ¢Ç¡ÇƒnullÇæÇ¡ÇΩÇÁèIóπ
	int grid_used_num;

	Color color;

	Prop2D_OGL *children[Prop::CHILDREN_ABS_MAX];
	int children_num;
	...
	inline bool addChild( Prop2D_OGL *p ){
		assert(p);
	...
	inline bool clearChild( Prop2D_OGL *p ) {
