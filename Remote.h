...
int sendUS1UIn( Stream *out, uint16_t usval, uint32_t *ui, size_t ui_n );
int sendUS1USn( Stream *out, uint16_t usval, uint16_t *us, size_t us_n );
...
int sendUS1UI2F2( Stream *out, uint16_t usval, uint32_t uival0, uint32_t uival1, float f0, float f1 ) ;
int sendUS1UI3F2( Stream *out, uint16_t usval, uint32_t uival0, uint32_t uival1, uint32_t uival2, float f0, float f1 ) ;
...
int sendUS1Str( Stream *out, uint16_t usval, const char *cstr );
